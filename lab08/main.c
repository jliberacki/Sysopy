...
int main(int argc, char **argv){
    ...
    if(file == NULL) FAILURE_EXIT(3, "Error during file opening 1\n");
    char* nullptr = NULL;
    ...
    fclose(file);
    file = fopen(argv[4],"r");
    if(file == NULL) FAILURE_EXIT(3, "Error during file opening 2\n");
    ...
    file = fopen(argv[5],"w");
    if(file == NULL) FAILURE_EXIT(3, "Error during file opening 3\n");
